var sidebarMenu = angular.module('sidebarMenu', ['ngRoute'])
    .config(function ($locationProvider, $routeProvider) {
        ...
        $routeProvider
            .when('/', {templateUrl: '/partials/currency-info.html'})
            .when('/stable-curr', {templateUrl: '/partials/stable-curr.html'})
            .when('/currency-info', {templateUrl: '/partials/currency-info.html'})
