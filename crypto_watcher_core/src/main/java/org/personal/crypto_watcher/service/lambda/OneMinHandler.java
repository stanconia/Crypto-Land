package org.personal.crypto_watcher.service.lambda;
...
public class OneMinHandler implements  RequestHandler<Void ,Void> {

    private static final Logger logger = Logger.getLogger(OneMinHandler.class);
